          ...
          <ul class="list-unstyled mb-0">
            <li class="g-pb-3">
              <router-link v-bind:to="{ name: 'RecivedComments' }" v-bind:active-class="'active g-color-primary--active g-bg-gray-light-v5--active'" class="d-block align-middle u-link-v5 g-color-text g-color-primary--hover g-bg-gray-light-v5--hover rounded g-pa-3">
                ...
                Comments
                <span v-if="notifications.unread_recived_comments_count" id="unread_recived_comments_count" class="u-label g-font-size-11 g-bg-pink g-rounded-20 g-px-8 g-ml-15">{{ notifications.unread_recived_comments_count }}</span>
              </router-link>
            </li>
            <li class="g-py-3">
              <router-link v-bind:to="{ name: 'MessagesIndex' }" v-bind:active-class="'active g-color-primary--active g-bg-gray-light-v5--active'" class="d-block align-middle u-link-v5 g-color-text g-color-primary--hover g-bg-gray-light-v5--hover rounded g-pa-3">
                ...
                Messages
                <span v-if="notifications.unread_messages_count" id="unread_messages_count" class="u-label g-font-size-11 g-bg-pink g-rounded-20 g-px-8 g-ml-15">{{ notifications.unread_messages_count }}</span>
              </router-link>
            </li>
            <li class="g-py-3">
              <router-link v-bind:to="{ name: 'Follows' }" v-bind:active-class="'active g-color-primary--active g-bg-gray-light-v5--active'" class="d-block align-middle u-link-v5 g-color-text g-color-primary--hover g-bg-gray-light-v5--hover rounded g-pa-3">
                ...
                Follows
                <span v-if="notifications.unread_follows_count" id="unread_follows_count" class="u-label g-font-size-11 g-bg-pink g-rounded-20 g-px-8 g-ml-15">{{ notifications.unread_follows_count }}</span>
              </router-link>
            </li>
            <li class="g-py-3">
              <router-link v-bind:to="{ name: 'PostsLikes' }" v-bind:active-class="'active g-color-primary--active g-bg-gray-light-v5--active'" class="d-block align-middle u-link-v5 g-color-text g-color-primary--hover g-bg-gray-light-v5--hover rounded g-pa-3">
                ...
                Posts Likes
                <span v-if="notifications.unread_posts_likes_count" id="unread_posts_likes_count" class="u-label g-font-size-11 g-bg-pink g-rounded-20 g-px-8 g-ml-15">{{ notifications.unread_posts_likes_count }}</span>
              </router-link>
            </li>
            <li class="g-py-3">
              <router-link v-bind:to="{ name: 'CommentsLikes' }" v-bind:active-class="'active g-color-primary--active g-bg-gray-light-v5--active'" class="d-block align-middle u-link-v5 g-color-text g-color-primary--hover g-bg-gray-light-v5--hover rounded g-pa-3">
                ...
                Comments Likes
                <span v-if="notifications.unread_comments_likes_count" id="unread_comments_likes_count" class="u-label g-font-size-11 g-bg-pink g-rounded-20 g-px-8 g-ml-15">{{ notifications.unread_comments_likes_count }}</span>
              </router-link>
            </li>
            <li class="g-py-3">
              <router-link v-bind:to="{ name: 'FollowingPosts' }" v-bind:active-class="'active g-color-primary--active g-bg-gray-light-v5--active'" class="d-block align-middle u-link-v5 g-color-text g-color-primary--hover g-bg-gray-light-v5--hover rounded g-pa-3">
                ...
                Following Posts
                <span v-if="notifications.unread_followeds_posts_count" id="unread_followeds_posts_count" class="u-label g-font-size-11 g-bg-pink g-rounded-20 g-px-8 g-ml-15">{{ notifications.unread_followeds_posts_count }}</span>
              </router-link>
            </li>
          </ul>
          <!-- End 菜单列表 -->
